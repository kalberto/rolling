...
Menu_inicial::Menu_inicial()
{
	...
	Mymouse = new MyMouse;
	ConfigButton = new ConfigsButton(1280,680);
	m_frame_atual = 0;
	m_frameCount = 1;
	...
	m_frame_exit = 0;
	 ...
	 m_sprite_bg = C2D2_CarregaSpriteSet("Mundo/Imagens/bg_rollin.png", 1366, 768);
	 m_sprite_start = C2D2_CarregaSpriteSet("Mundo/Imagens/start_sprite.png", 287, 100);
	 m_sprite_exit = C2D2_CarregaSpriteSet("Mundo/Imagens/exit_sprite.png", 287, 100);
...
//	C2D2_DesenhaSprite(m_sprite_mask, 0, m_x, m_y);
	...
	//anins
	C2D2_DesenhaSprite(m_sprite_gears, m_frame_gears, 600, 215);
}
...
void Menu_inicial::Update()
{
	...
	Animador(&m_frameCount, &m_frame_gears, 0.06); // ANIMAÇÃO ENGRENAGENS
}
